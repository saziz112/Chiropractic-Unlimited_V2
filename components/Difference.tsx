            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-20">
                    <RevealOnScroll>
                        ...
                        <p className="text-white/95 text-lg max-w-3xl mx-auto leading-relaxed font-medium">
                    ...
                    {DIFFERENCE_POINTS.map((point, index) => (
                        <RevealOnScroll key={index} delay={index * 100}>
                            <div className="text-center group">
                                <div className="bg-white/5 border border-white/10 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-8 text-brand-accent backdrop-blur-sm shadow-inner group-hover:bg-white/15 group-hover:border-white/25 transition-all duration-300">
                                    {point.icon}
                                </div>
