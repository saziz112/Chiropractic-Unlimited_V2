          ...
          <div className="lg:col-span-7">
            <RevealOnScroll delay={200}>
              ...
              <div className="mt-12 flex gap-6">
                 ...
                 <div className="px-8 py-4 bg-brand-bg rounded-xl border border-brand-primary/10 text-center min-w-[120px]">
                    <span className="block text-2xl font-bold text-brand-primary font-display mb-1">BSN RN</span>
                    <span className="text-[10px] uppercase tracking-widest text-brand-muted font-bold">Registered Nurse</span>
                 </div>
              </div>
            </RevealOnScroll>
          </div>
