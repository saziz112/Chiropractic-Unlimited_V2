    ...
    <section id="testimonials" className="py-16 md:py-24 bg-brand-bg relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <RevealOnScroll>
            <span className="text-brand-accent font-semibold tracking-widest uppercase text-xs mb-4 block">Success Stories</span>
            <h2 className="text-4xl md:text-5xl font-display text-brand-primary mb-4">
             ...
             <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 text-brand-primary font-bold hover:text-brand-secondary transition-colors group mt-2"
            >
