...
export const BUSINESS_INFO = {
  ...
  locationNote: "Located INSIDE the Workout Anytime gym, in the same plaza as Ace Hardware. The phone number on the gym signage (334.219.0150) is for Workout Anytime — to reach Dr. Bang directly, call (334) 203-7032.",
...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    metaTitle: "Spinal Adjustments in Valley, AL | Gentle Chiropractic Care",
  ...
  },
  {
    ...
    metaTitle: "Integrated Chiropractic + Medical Care | Valley, AL DC + FNP",
...
export const CONDITIONS: ConditionItem[] = [
  ...
  },
  {
    ...
    metaTitle: "Auto Accident Chiropractor in Valley, AL | Whiplash + Injury",
